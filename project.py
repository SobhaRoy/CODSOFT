...
# Picture
rock_img = ImageTk.PhotoImage(Image.open("rock-comp.jpeg").resize((350, 350)))
paper_img = ImageTk.PhotoImage(Image.open("paper-user.jpeg").resize((350, 350)))
scissor_img = ImageTk.PhotoImage(Image.open("scissors-user.jpeg").resize((350, 350)))
rock_img_comp = ImageTk.PhotoImage(Image.open("rock-user.jpeg").resize((350, 350)))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper-comp.jpeg").resize((350, 350)))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissors_comp.jpeg").resize((350, 350)))
